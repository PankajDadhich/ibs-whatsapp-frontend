  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (selectedFiles === null) {
        ...
        result = await WhatsAppAPI.saveStaffMemberEditProfile(
          profile.id,
          selectedFiles,
          ...
          <Col lg={8} sm={12} xs={12} className="ps-4">
            <Row className="view-form-header align-items-center p-3">
              <Col lg={12} sm={12} xs={12}>
                Edit Profile
                <Button
                  className="btn-sm text-end float-end"
            ...
            <Row className="pb-4 py-4 ibs-edit-form">
              ...
              <Col lg={6} sm={12} xs={12}>
                <Form.Group className="mx-3 mb-3" controlId="formBasicLastName">
                  <Form.Label className="form-view-label">Last Name</Form.Label>
                  <Form.Control
                    style={{ height: "36px" }}
                    required
                    type="text"
              ...
              <Col lg={6} sm={12} xs={12}>
                <Form.Group className="mx-3 mb-3" controlId="formBasicEmail">
                  <Form.Label className="form-view-label">Email</Form.Label>
                  <Form.Control
                    style={{ height: "36px" }}
                    required
                    type="email"
