                ...
                <Row className="ibs-edit-form">
                  <Col lg={12} ref={props.innerRef} id="pdf-div">
                    ...
                    <Row className="mx-5 mb-3">
                      <Col lg={4}>
                        ...
                        <span>
                          {invoice?.payment_method
                            ? capitalizeFirstLetter(invoice?.payment_method)
                            : "--"}
                        </span>
                      </Col>
                      <Col lg={4}>
                      ...
                      <span className="mt-5" style={{ fontSize: "1.1rem" }}>
                        <font color={"red"}>*</font> Can maintain the data of{" "}
                        <b>{invoice.number_of_whatsapp_setting}</b> Active
                        Whatsapp Settings.
                      </span>
                    </Row>
