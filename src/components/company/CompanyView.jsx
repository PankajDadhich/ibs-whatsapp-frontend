  ...
  const header = [
    {
      title: "Invoice ID",
      prop: "invoice_no",
      cell: (row) => <Link to={"/invoice/" + row.id}>ID-{row.invoice_no}</Link>,
    },
    ...
    { title: "Validity (in Months)", prop: "validity", isFilterable: true },
    {
      ...
      cell: (row) => {
        ...
        if (row.status === "Complete") {
          ...
          badgeColor = "danger";
          value =
            new Date() < new Date(row.payment_due_date) ? "Due" : "Over Due";
        ...
        return (
          <>
            ...
            <h5>
              <Badge bg={badgeColor} style={{ width: "80px", padding: "6px" }}>
                {value}
              </Badge>
            </h5>
          </>
          ...
          <>
            {row.status === "Pending" ? (
              <>
                ...
                >
                  <i className="fa-regular fa-pen-to-square"></i> Cancel Invoice
                </Button>
              </>
            ) : (
              ""
          ...
          <Col lg={12} sm={12} xs={12}>
            <Row className="py-2 ibs-edit-form">
              ...
              <Col lg={6} sm={6} xs={6} className="mb-2">
                ...
                <span className="text-capitalize">
                  {company.tenantcode ? company.tenantcode : <>&nbsp;</>}
                </span>
              </Col>
              <Col lg={6} sm={6} xs={6} className="mb-2">
              ...
              <Col lg={6} sm={6} xs={6} className="mb-2">
                ...
                <span>
                  {company.systememail ? company.systememail : <>&nbsp;</>}
                </span>
              </Col>
              <Col lg={6} sm={6} xs={6} className="mb-2">
                <label>City</label>
        ...
        <Card bg="light" text="light" className="mx-5 mt-4">
          <Card.Header className="d-flex card-header-grey justify-content-between">
            <Tabs
              ...
              onSelect={(key) => handleMainTab(key)}
            >
