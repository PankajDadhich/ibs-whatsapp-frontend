...
const CreateCompany = () => {
  ...
  const steps = ['Schema Information', 'Company Information', 'Company Address', 'User Information', 'Subscription Plans'];
  ...
  const fetchCompany = async (id) => {
    try {
      ...
      if (response.companyResult) {
        ...
        const selected = availablePlans.find((plan) => plan.plan_info.id === companyData.plan_id);
        setIsFreePlan(true);
        ...
        setFormData({
          ...
          invoice: {
            ...
            date: new Date(companyData.invoice_date).toISOString().split('T')[0],
  ...
  const validateStep = () => {
    ...
    if (formNumber === 0) {
      ...
      if (isEditMode) {
        return source_schemaname.trim() !== '' && target_schemaname.trim() !== '';
      }
    ...
    if (formNumber === 1) {
      ...
      const isLogoFileValid = (logourl instanceof File && logourl.name.trim() !== '') || (typeof logourl === 'string' && logourl.trim() !== '');

      return (
        formData.company_info.name.trim() !== '' &&
        systememail.trim() !== '' &&
        isSystemEmailValid && isLogoFileValid);
    }
    ...
    if (formNumber === 3) {
      return (
        ...
        formData.user_info.whatsapp_number.trim() !== '' &&
  ...
  const handlePlanChange = (e) => {
    ...
    const selected = availablePlans.find((plan) => String(plan.plan_info.id) === String(selectedPlanId));
  ...
  const handleAmountTypeChange = (e) => {
    ...
    setFormData((prev) => ({
      ...
      invoice: {
        ...prev.invoice,
        validity: selectedAmount === selectedPlan.plan_info.price_per_month ? 1 : 12,
  ...
  const handleNextClick = async () => {
    if (formNumber === 1) {
      const selected = availablePlans.find((plan) => plan.plan_info.id === formData.invoice.plan);
      setSelectedPlan(selected);
    }
    if (formNumber === 3) {
      const { adminemail, companyId } = formData.company_info;
      try {
        const emailCheckResponse = await WhatsAppAPI.duplicateEmailCheck(adminemail, companyId);
              ...
              <Card.Header>
                <div className="d-flex justify-content-between align-items-center">
                  {steps.map((step, index) => (
                    ...
                    >
                      <div
                        className={`rounded-circle d-inline-flex align-items-center justify-content-center ${index === formNumber ? 'bg-white text-primary' : 'rgb(125 156 233) text-white'
                          }`}
                  ...
                  <Col>
                    {formNumber === 0 && (
                      <Form>
                        ...
                        <p className='text-muted mb-4'><em>Enter your Schema information.</em></p>
                        <Row className='mb-3'>
                    ...
                    {formNumber === 1 && (
                      <Form>
                        ...
                        <p className='text-muted mb-4'><em>Enter your Company information.</em></p>
                        <Row className="mb-3">
                          <Col md={6}>
                            <Form.Group>
                              ...
                              <Form.Control
                                ...
                                onChange={(e) => handleChange(e, 'company_info')}
                                required
                              />
                            </Form.Group>
                          </Col>
                          ...
                          <Col md={6}>
                                <Form.Group className="mb-3">
                                  ...
                                  <Form.Control
                                    type="file"
                                    accept=".png, .jpg"
                                    onChange={(e) => handleFileUpload(e, 'company_info', 'logourl')} required
                                  />
                                </Form.Group>
                              </Col>
                              <Col md={6}>
                            ...
                            <Form.Group>
                              ...
                              <div>
                                <Form.Check
                                  ...
                                  label="Active"
                                  name="isactive"
                                  checked={formData.company_info.isactive === true}
                                  onChange={(e) =>
                                    handleChange(
                                      {
                                        target: {
                    ...
                    {formNumber === 2 && (
                      <Form>
                        ...
                        <p className='text-muted mb-4'><em>Enter your Company Address.</em></p>
                        <Row className="mb-3">
                          <Col md={12}>
                            <Form.Group>
                    ...
                    {formNumber === 3 && (
                      <Form>
                        ...
                        <p className='text-muted mb-4'><em>Enter your User Information.</em></p>
                        <Row className="mb-3">
                          <Col md={6}>
                            <Form.Group>
                          ...
                          <Col md={6}>
                            <Form.Group>
                              ...
                              <Form.Control
                                ...
                                value={formData.user_info.whatsapp_number}
                                onChange={(e) => handleChange(e, 'user_info')}
                                required
                              />
                            </Form.Group>
                            ...
                            <Col md={6}>
                              <Form.Group className='mb-3'>
                                ...
                                <div style={{ position: 'relative' }}>
                                  <Form.Control
                                    style={{ height: '36px', paddingRight: '40px' }}
                    ...
                    {formNumber === 4 && (
                      <Form >
                        ...
                        <p className='text-muted mb-4'><em>Select Plan.</em></p>
                        <Row className='mb-3'>
                          <Col md={6}>
                            <Form.Group>
                              ...
                              >
                                ...
                                {availablePlans.map((plan) => (
                                  <option key={plan.plan_info.id} value={plan.plan_info.id}>
                                    {plan.plan_info.name}
                                  </option>
                                ))}
                              </Form.Control>
                        ...
                        {selectedPlan && (
                          <>
                            <Row>
                              <Col md={6}>
                                <Form.Group>
                                  <strong>Number of Users</strong> : {selectedPlan.plan_info.number_of_users || 0} <br />
                                  <strong>Number of WhatsApp Settings</strong> : {selectedPlan.plan_info.number_of_whatsapp_setting || 0}
                                </Form.Group>
                              </Col>
                              <Col md={6}>
                                {selectedPlan.plan_info.price_per_month > 0 || selectedPlan.plan_info.price_per_year > 0 ? (
                                  <Form.Group>
                                    ...
                                    <div className="d-flex align-items-center">
                                      {selectedPlan.plan_info.price_per_month > 0 && (
                                        <Form.Check
                                          type="radio"
                                          name="amount"
                                          value={selectedPlan.plan_info.price_per_month}
                                          label={`Monthly: ₹ ${selectedPlan.plan_info.price_per_month}`}
                                          checked={formData.invoice.amount === selectedPlan.plan_info.price_per_month}
                                      ...
                                      {selectedPlan.plan_info.price_per_year > 0 && (
                                        <Form.Check
                                          type="radio"
                                          name="amount"
                                          value={selectedPlan.plan_info.price_per_year}
                                          label={`Yearly: ₹ ${selectedPlan.plan_info.price_per_year}`}
                                          checked={formData.invoice.amount === selectedPlan.plan_info.price_per_year}
                                          onChange={handleAmountTypeChange}
                                        />
                                      )}
                            ...
                            <Row>
                              <Col>
                                ...
                                <div className="mt-3">
                                  ...
                                  <Row className="mt-2">
                                    {selectedPlan.plan_modules.map((module, index) => {
                                      return (
                    ...
                    <div className="text-end">
                      ...
                      {formNumber === steps.length - 1 ? (
                        <Button variant="primary" onClick={handleFormSubmit} disabled={!validateStep()}>
                          Submit
                        </Button>
                      ) : (
                        <Button variant="primary" onClick={handleNextClick} disabled={!validateStep()}>
                          Next Step
                        </Button>
                      )}
                    </div>
