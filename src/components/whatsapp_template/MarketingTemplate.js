...
const MarketingTemplate = ({ previewData, selectedWhatsAppSetting }) => {
                                    ...
                                    <Row className='mb-3'>
                                        <Col lg={6} sm={12} xs={12}>
                                            {rowData.header === 'IMAGE' &&
                                                <>
                                                    <Form.Group className='mb-3 mx-3'>
                                                        <Form.Label>Upload Image</Form.Label> <Form.Text muted>(Image Supported: .jpg, .jpeg, .png)</Form.Text>
                                                        <Form.Control
                                                            required
                                                            type="file"
                                            ...
                                            {rowData.header === 'DOCUMENT' &&
                                                <>
                                                    <Form.Group className='mb-3 mx-3'>
                                                        <Form.Label>Upload Document</Form.Label> <Form.Text muted>(Document Supported: .pdf)</Form.Text>
                                                        <Form.Control
                                                            required
                                                            type="file"
                                            ...
                                            {rowData.header === 'VIDEO' &&
                                                <>
                                                    <Form.Group className='mb-3 mx-3'>
                                                        <Form.Label>Upload Video</Form.Label> <Form.Text muted>(Video Supported: .mp4)</Form.Text>
                                                        <Form.Control
                                                            required
                                                            type="file"
                                    ...
                                    <Row className='mb-3'>
                                        <Col lg={12} sm={12} xs={12}>
                                            ...
                                            <div className='mb-3 mx-3'>
                                                <Col lg={12} sm={12} xs={12} className='text-end mb-2'>
                                                    <button className='format-text-btn' onClick={() => formatTextArea('*')} data-bs-toggle="tooltip" title="Bold"><i className="fa-solid fa-bold"></i></button>
